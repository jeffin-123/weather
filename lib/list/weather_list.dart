...
//
//     final weatherList = weatherListFromJson(jsonString);

import 'dart:convert';

WeatherList weatherListFromJson(String str) =>
    WeatherList.fromJson(json.decode(str));

String weatherListToJson(WeatherList data) => json.encode(data.toJson());
